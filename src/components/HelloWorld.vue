...
<style scoped>
  ...
  #mainbody { width: 100%;height: 100%; clear: both; background-color: #333333 }
  ...
  /*.details li a { color: rgba(218, 211, 134, 0.93)}*/
  ...
  /*!* CSS Document *!*/
  /** { margin: 0; padding: 0 }*/
  /*body { font: 12px "宋体", "Arial Narrow", HELVETICA; color: #3F3E3C; line-height: 1.5; background: #333; }*/
