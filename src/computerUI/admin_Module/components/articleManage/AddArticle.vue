<template>
  <div >
    ...
    <mavon-editor  v-model="articleForm.value" style="max-height: 72vh;padding: 20px;min-height: 50vh"></mavon-editor>
    <el-footer>
      <el-form ref="form" :model="articleForm" >
        ...
        <span class="el-col-12">
          ...
          <el-form-item label="文章分类:">
            ...
            <el-checkbox @change="selectedList(listItem2)" v-for="listItem2 in articleForm.categoryList" :key="listItem2">{{listItem2}}</el-checkbox>
